...
public class SendMailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String subject = "네이버를 이용한 메일발송 연습입니다."; // 제목
		String from = "o_b98@naver.com"; // 보내는 사람의 메일
		String fromName = "운영자";
		String to = "o_b98@naver.com"; // 받는 사람의 메일
		...
		try {
			...
			Authenticator auth = new SendMail(); /// id/pw 인증
