...
$(function (){
	...
	// 이메일 option 선택시 자동 입력
	$("select").change(function (){
		$("#email2").val($(this).val());
	});
});
</script>    
<form action="MemberAddServlet" method="get" align="center">
...
<input type="text" name="phone2" maxlength="4">-<input type="text" name="phone3" maxlength="4">
<br>
